plot1 <- function() {
    ...
    # Debug
    #to_print <- sprintf("XXXDebug: Writing plotted subset of data to .csv file...")
    #cat(" ", to_print, "\n")
    #write.csv(electric_power_consumption_data_Feb_1_and_2_2007,file="subsetted_data.csv")
    to_print <- sprintf("Creating plot file...")
    cat(" ", to_print, "\n")
    png(file="plot1.png",width=480,height=480)
    hist(electric_power_consumption_data_Feb_1_and_2_2007$Global_active_power, 
